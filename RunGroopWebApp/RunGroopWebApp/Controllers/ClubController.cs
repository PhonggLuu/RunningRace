...
namespace RunGroopWebApp.Controllers
{
    public class ClubController : Controller
    {
        ...
        public ClubController(IClubRepository clubRepository, IPhotoService photoService, IHttpContextAccessor htttpContextAccessor)
        {
        ...
        {
            var curUserId = _htttpContextAccessor.HttpContext.User.GetUserId();
        ...
        public async Task<IActionResult> Edit(int id, EditClubViewModel clubVM)
        {
            ...
            Club oldClub = await _clubRepository.GetClubByIdAsyncNoTracking(id);
            if(oldClub != null)
            {
                try
                {
                ...
                ImageUploadResult photoResult = await _photoService.AddPhotoAsync(clubVM.Image);
                Club club = new Club
                {
                    Id = id,
                    Title = clubVM.Title,
